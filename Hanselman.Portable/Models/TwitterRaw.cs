...
namespace QuickType
{
    ...
    public enum ProfileSidebarBorderColor { B8Aa9C, C0Deed, Eeeeee, Ffffff, The000000, The87Bc44 };
    ...
    internal class ProfileSidebarBorderColorConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type t, object existingValue, JsonSerializer serializer)
        {
            ...
            switch (value)
            {
                ...
                case "87BC44":
                    return ProfileSidebarBorderColor.The87Bc44;
                case "B8AA9C":
        ...
        public override void WriteJson(JsonWriter writer, object untypedValue, JsonSerializer serializer)
        {
            ...
            switch (value)
            {
                case ProfileSidebarBorderColor.The000000:
                    ...
                    return;
                case ProfileSidebarBorderColor.The87Bc44:
                    serializer.Serialize(writer, "87BC44");
                    return;
